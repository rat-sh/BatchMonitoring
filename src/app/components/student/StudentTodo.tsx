...
const RECOMMENDATIONS = [
  ...
  'Complete pending assignments before deadline',
  'Review upcoming exam topics',
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-gray-900">My To-Do List</h2>
        <button
      ...
      <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-200 p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-gray-900">Recommended Tasks</h3>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-3">
          ...
          {activeTodos.length === 0 && (
            <p className="text-center text-gray-500 py-8">No active tasks. You&apos;re all caught up!</p>
          )}
        </div>
      </div>
